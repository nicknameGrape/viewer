...
const SETS = {
	...
	"Acronym Quiz" [
		...
		"sets\acronym_quiz (4).png",
		"sets\acronym_quiz (5).png",
		"sets\acronym_quiz (6).png",
		"sets\acronym_quiz (7).png",
		"sets\acronym_quiz (8).png",
		"sets\acronym_quiz (9).png",
		"sets\acronym_quiz (10).png",
		"sets\acronym_quiz (11).png",
		"sets\acronym_quiz (12).png",
		"sets\acronym_quiz (13).png",
		"sets\acronym_quiz (14).png",
		"sets\acronym_quiz (15).png",
		"sets\acronym_quiz (16).png",
		"sets\acronym_quiz (17).png",
		"sets\acronym_quiz (18).png",
		"sets\acronym_quiz (19).png",
		"sets\acronym_quiz (20).png",
		"sets\acronym_quiz (21).png",
		"sets\acronym_quiz (22).png",
		"sets\acronym_quiz (23).png",
		"sets\acronym_quiz (24).png",
		"sets\acronym_quiz (25).png",
		"sets\acronym_quiz (26).png",
		"sets\acronym_quiz (27).png",
		"sets\acronym_quiz (28).png",
		"sets\acronym_quiz (29).png",
		"sets\acronym_quiz (30).png",
		"sets\acronym_quiz (31).png",
		"sets\acronym_quiz (32).png"
	],
	"おやこ Hunt": [
